...
$(PROGRAM_NAME): $(SRCDIR)/modif_img.cpp $(SRCDIR)/mykernel_pixel_saturation.cu $(SRCDIR)/mykernel_horizontal_symmetry.cu\
 ...
 $(SRCDIR)/mykernel_diapositive.cu $(SRCDIR)/mykernel_one_pixel.cu $(SRCDIR)/mykernel_canny_filter.cu $(SRCDIR)/mykernel_popArt.cu $(SRCDIR)/mykernel_popArt_4streams.cu
